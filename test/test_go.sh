#!/bin/bash
#
# Test script for Custom LLM Server (Go / Gin)
...
#
# Usage: bash test_go.sh [base_url]
#   base_url defaults to http://localhost:8102

set -euo pipefail

BASE_URL="${1:-http://localhost:8102}"
PASS=0
FAIL=0
...
echo "========================================="
echo "Custom LLM Server Tests (Go)"
